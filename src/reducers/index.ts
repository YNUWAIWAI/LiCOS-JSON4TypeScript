...
import commandGrave, {State as commandGraceState} from 'client/village/reducers/commandGrave'
import commandInputBox, {State as commandInputBoxState} from 'client/village/reducers/commandInputBox'
import commandPostMortem, {State as commandPostMortemState} from 'client/village/reducers/commandPostMortem'
import commandSelection, {State as commandSelectionState} from 'client/village/reducers/commandSelection'
import language, {State as languageState} from 'client/village/reducers/language'
